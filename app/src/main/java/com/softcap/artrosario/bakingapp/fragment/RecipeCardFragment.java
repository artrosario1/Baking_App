...
public class RecipeCardFragment extends Fragment implements RecipeCardAdapter.RecipeCardClickHandler {
   ...
   private ArrayList<Recipe> recipeList = new ArrayList<>();
    ...
    public void putInSharedPreferences(Recipe recipe){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        SharedPreferences.Editor editor = preferences.edit();
        List<Ingredient> ingredientsList;
        ingredientsList = recipe.getIngredientList();
        editor.putString("RecipeNo", recipe.recipeId);
        editor.putInt("Size", ingredientsList.size());
        editor.apply();
    }
